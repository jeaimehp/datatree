...
__author__ = 'Cody Giles Modified by Jeaime Powell'
...
# Account Information
to = 'jpowell@tacc.utexas.edu' # Email to send to.
gmail_user = 'texashydrotree@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'xxxxxxxxxx' # Gmail password.
...
msg = 'Subject ' + 'IP of Datatree on ' + today.strftime('%b %d %Y') + "\n" + str(data) 
